...
<html lang="en">
  ...
  <body>
    ...
    <div class="container productos  mt-4">
        <h2 class="text-center"> Multiservicios Braalanma Le ofrece una variedad de Mesas</h2>
        ...
        <div class="row mt-4">
          ...
          <div class="col-md-6 mb-4 mb-md-0">
            ...
            <?php
                ...
                $sqlQuery="SELECT * FROM Producto WHERE Idproducto='1' ";
          ...
          <div class="col-md-6 mb-4 mb-md-0">
            ...
            <?php
                include_once 'conexion.php';
                $mysqlConexion=new mysqli($hostDb,$usuarioDb,$claveDb,$nombreDb);
                $sqlQuery="SELECT * FROM Producto WHERE Idproducto='2' ";
                $resultado=$mysqlConexion->query($sqlQuery);
                while ($row=$resultado->fetch_assoc()){
              ?>
              <img src="<?php  echo $row["images"];?>" class="img-fluid">
        ...
        <div class="row mt-4 justify-content-center">
          <div class="col-md-6 col-lg-4 mb-4 mb-md-4">
            ...
            <?php
                include_once 'conexion.php';
                $mysqlConexion=new mysqli($hostDb,$usuarioDb,$claveDb,$nombreDb);
                $sqlQuery="SELECT * FROM Producto WHERE Idproducto='3' ";
                $resultado=$mysqlConexion->query($sqlQuery);
                while ($row=$resultado->fetch_assoc()){
              ?>
              <img src="<?php  echo $row["images"];?>" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-4">
            ...
            <?php
                include_once 'conexion.php';
                $mysqlConexion=new mysqli($hostDb,$usuarioDb,$claveDb,$nombreDb);
                $sqlQuery="SELECT * FROM Producto WHERE Idproducto='4' ";
                $resultado=$mysqlConexion->query($sqlQuery);
                while ($row=$resultado->fetch_assoc()){
              ?>
              <img src="<?php  echo $row["images"];?>" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-4">
            ...
            <?php
                include_once 'conexion.php';
                $mysqlConexion=new mysqli($hostDb,$usuarioDb,$claveDb,$nombreDb);
                $sqlQuery="SELECT * FROM Producto WHERE Idproducto='5' ";
                $resultado=$mysqlConexion->query($sqlQuery);
                while ($row=$resultado->fetch_assoc()){
              ?>
              <img src="<?php  echo $row["images"];?>" class="img-fluid">
