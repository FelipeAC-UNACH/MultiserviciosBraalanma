...
<head>
    ...
    <link rel="stylesheet" href="../css_index/Stilos.css">
     ...
     <!-- SCRIPTS-->
     <link rel="stylesheet" href="../css_contacto/estilos_compras.css">
    ...
    <header class="header">
        ...
        <section class="form_wrap">
          <?php
            ...
            $sqlQuery="SELECT * FROM  Servicio WHERE Idservicio='$id'";
            $resultado=$mysqlConexion->query($sqlQuery);
            $row=$resultado->fetch_assoc();

          ?>
          <img src="<?php  echo $row["imagen"];?>" class="nosotros_info2">
          <form action ="enviar_servicio.php" method="POST" class="form_contact">
              <h2> Detalles de tu Pedido</h2>
              <label for="names" >Producto</label>

                  <input type="text" name="Idservicio" readonly ="readonly"placeholder="Producto"  value="<?php echo $row['Idservicio']; ?>"> 
  
                  <label for="names" >Nombre</label>
                  <input type="text" name="Nombres" readonly ="readonly"placeholder="Nombre"  value="<?php echo $row['NombreS'];?>"> 

                  <center><h5> Ingresa tus datos para poder mandarte tu compra</h5></center >
              <div class="user_info">
                  <label for="names" >Nombres *</label>
                  <input type="text" id="names" name="nombrec" required>
