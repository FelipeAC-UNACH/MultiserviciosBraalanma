...
<html lang="en">
  ...
  <body>
    ...
    <div class="container productos  mt-4">
        <h2 class="text-center"> Multiservicios Braalanma Le ofrece una variedad de Estantes para macetas</h2>
        ...
        <div class="row mt-4">
          ...
          <div class="col-md-6 mb-4 mb-md-0">
            ...
            <?php
                ...
                $sqlQuery="SELECT * FROM Producto WHERE Idproducto='16' ";
          ...
          <div class="col-md-6 mb-4 mb-md-0">
            ...
            <?php
              include_once 'conexion.php';
              $mysqlConexion=new mysqli($hostDb,$usuarioDb,$claveDb,$nombreDb);
              $sqlQuery="SELECT * FROM Producto WHERE Idproducto='17' ";
              $resultado=$mysqlConexion->query($sqlQuery);
              while ($row=$resultado->fetch_assoc()){
              ?>
              <img src="<?php  echo $row["images"];?>" class="img-fluid">
        ...
        <div class="row mt-4 justify-content-center">
          <div class="col-md-6 col-lg-4 mb-4 mb-md-4">
            ...
            <?php
              include_once 'conexion.php';
               $mysqlConexion=new mysqli($hostDb,$usuarioDb,$claveDb,$nombreDb);
               $sqlQuery="SELECT * FROM Producto WHERE Idproducto='18' ";
               $resultado=$mysqlConexion->query($sqlQuery);
               while ($row=$resultado->fetch_assoc()){
              ?>
              <img src="<?php  echo $row["images"];?>" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-4">
            ...
            <?php
                include_once 'conexion.php';
                $mysqlConexion=new mysqli($hostDb,$usuarioDb,$claveDb,$nombreDb);
                $sqlQuery="SELECT * FROM Producto WHERE Idproducto='19' ";
                $resultado=$mysqlConexion->query($sqlQuery);
                while ($row=$resultado->fetch_assoc()){
              ?>
              <img src="<?php  echo $row["images"];?>" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-4">
            ...
            <?php
                include_once 'conexion.php';
                $mysqlConexion=new mysqli($hostDb,$usuarioDb,$claveDb,$nombreDb);
                $sqlQuery="SELECT * FROM Producto WHERE Idproducto ='20' ";
                $resultado=$mysqlConexion->query($sqlQuery);
                while ($row=$resultado->fetch_assoc()){
            ?>
              <img src="<?php  echo $row["images"];?>" class="img-fluid">
              <h4 class="text-center mb-2"><?php  echo $row["Nombrep"];?></h4>
              <p>$ <?php  echo $row["Precio"];?> </p>
              <p class="recio font-weight-bold"> </p>
              <a class="btn btn-success mb-2 btn-lg text-uppercase font-weight-bold" href="compra_p.php?id=<?php echo $row['Idproducto']; ?>"> Lo Quiero </a>
              <?php
