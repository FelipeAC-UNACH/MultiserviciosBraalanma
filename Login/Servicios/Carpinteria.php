...
<html lang="en">
  ...
  <body>
    ...
    <?php
            ...
            $sqlQuery="SELECT * FROM Servicio WHERE Idservicio='9' ";
       ...
       <p> Dispone de los equipos técnicos y humanos necesarios para satisfacer este tipo de trabajos poniendo a disposición de nuestros clientes a precios altamente competitivos, un amplio abanico de soluciones para todo tipo de viviendas </p> 
       <p> Armarios y puertas estándar, registros y cualquier necesidad de obra, además de cualquier tipo de acabados, madera, melamina, pvc, cpl etc… en definitiva cualquier producto necesario que demande este tipo de obra.   </p>
       <p> Con nuestro esfuerzo profesional diario y un control a pie de obra esmerado garantizamos la calidad del trabajo realizado y la entrega en los plazos convenidos. Gracias a la experiencia adquirida ofrecemos a nuestros clientes un amplio programa de servicios. </p>
       <p>   </p>
    ...
    <section id="galeria" class="container">
      ...
      <div class="row">
          ...
          <img src="../../img_index/Servicios/carpinteria_1.jpg">
          </div>

          <div class="col-lg-4 col-md-6 col-sm-12">
          <img src="../../img_index/Servicios/carpinteria_2.jpg">
          </div>

          <div class="col-lg-4 col-md-6 col-sm-12">
          <img src="../../img_index/Servicios/carpinteria_3.jpg">
          </div>

          <div class="col-lg-4 col-md-6 col-sm-12">
          <img src="../../img_index/Servicios/carpinteria_4.jpg">
          </div>

          <div class="col-lg-4 col-md-6 col-sm-12">
          <img src="../../img_index/Servicios/carpinteria_5.jpg">
          </div>

          <div class="col-lg-4 col-md-6 col-sm-12">
          <img src="../../img_index/Servicios/carpinteria_6.jpg">
          </div>
      </div>
    </section>
