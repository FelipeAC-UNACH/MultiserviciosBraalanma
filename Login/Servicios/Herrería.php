  ...
  <body>
    ...
    <div class="container-all">
        <?php
          ...
          $sqlQuery="SELECT * FROM Servicio WHERE Idservicio='2' ";
       ...
       <p>Somos una empresa especializada en servicios de herrería para el sector de la construcción y ofrecemos un amplio abanico de soluciones.</p>
       <p> Fabricamos todo tipo de herrería y ofrecemos servicios de mantenimiento estructural, instalación y diseño de portones automáticos, soldadura en general y fabricación de muebles para interiores y jardín, en forja o acero inoxidable.  </p>
       <p> En Multiservicios Braaalman nos esmeramos día a día, por superar nuestros estándares de calidad en nuestros trabajos. "tradición y tecnología en todos nuestros productos.    </p>
    ...
    <section id="galeria" class="container">
      ...
      <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-12">
            <img src="../../img_index/Servicios/herreria_1.jpg">
          </div>

          <div class="col-lg-4 col-md-6 col-sm-12">
          <img src="../../img_index/Servicios/herreria_2.jpg">
          </div>

          <div class="col-lg-4 col-md-6 col-sm-12">
          <img src="../../img_index/Servicios/herreria_3.jpg">
          </div>

          <div class="col-lg-4 col-md-6 col-sm-12">
          <img src="../../img_index/Servicios/herreria_4.jpg">
          </div>
